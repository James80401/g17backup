...
if(B){n=n||{},e="raven"+e.substr(0,1).toUpperCase()+e.substr(1),document.createEvent?(t=document.createEvent("HTMLEvents"),t.initEvent(e,!0,!0)):(t=document.createEventObject(),t.eventType=e)
...
for(n=3;n--;)t[o[n]]=r[n]}return t.in_app=!(H.includePaths.test&&!H.includePaths.test(t.filename)||/(Raven|TraceKit)\./.test(t["function"])||/raven\.(min\.)?js$/.test(t.filename)),t}}function h(e){if(e.context&&H.fetchContext){for(var n=e.context,t=~~(n.length/2),r=n.length,o=!1;r--;)if(n[r].length>300){o=!0
...
H.ignoreErrors.test&&H.ignoreErrors.test(n)||(n+="",c=e+": "+n,o&&o.length?(t=o[0].filename||t,o.reverse(),u={frames:o}):t&&(u={frames:[{filename:t,lineno:r,in_app:!0}]}),H.ignoreUrls.test&&H.ignoreUrls.test(t)||(!H.whitelistUrls.test||H.whitelistUrls.test(t))&&S(x({exception:{values:[{type:e,value:n,stacktrace:u}]},culprit:t,message:c},i)))}function x(e,n){return n?(g(n,function(n,t){e[n]=t}),e):e}function y(e,n){return e.length<=n?e:e.substr(0,n)+"…"}function w(e){var n=H.maxMessageLength
if(e.message=y(e.message,n),e.exception){var t=e.exception.values[0]
t.value=y(t.value,n)}return e}function b(){return+new Date}function E(){if(B&&document.location&&document.location.href){var e={headers:{"User-Agent":navigator.userAgent}}
return e.url=document.location.href,document.referrer&&(e.headers.Referer=document.referrer),e}}function S(e){var n={project:D,logger:H.logger,platform:"javascript"},t=E()
t&&(n.request=t),e=x(n,e),e.tags=x(x({},K.tags),e.tags),e.extra=x(x({},K.extra),e.extra),e.extra["session:duration"]=b()-Y,l(e.tags)&&delete e.tags,K.user&&(e.user=K.user),H.release&&(e.release=H.release),H.serverName&&(e.server_name=H.serverName),c(H.dataCallback)&&(e=H.dataCallback(e)||e),e&&!l(e)&&(!c(H.shouldSendCallback)||H.shouldSendCallback(e))&&(I=e.event_id||(e.event_id=O()),e=w(e),j("debug","Raven about to send:",e),C()&&(H.transport||k)({url:P,auth:{sentry_version:"7",sentry_client:"raven-js/"+Q.VERSION,sentry_key:W},data:e,options:H,onSuccess:function(){r("success",{data:e,src:P})},onError:function(){r("failure",{data:e,src:P})}}))}function k(e){e.auth.sentry_data=JSON.stringify(e.data)
var n=R(),t=e.url+"?"+U(e.auth),r=e.options.crossOrigin;(r||""===r)&&(n.crossOrigin=r),n.onload=e.onSuccess,n.onerror=n.onabort=e.onError,n.src=t}function R(){return document.createElement("img")}function C(){return V?P?!0:(tn||j("error","Error: Raven has not been configured."),tn=!0,!1):!1}function _(e){for(var n,t=[],r=0,o=e.length;o>r;r++)n=e[r],a(n)?t.push(n.replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1")):n&&n.source&&t.push(n.source)
...
return t.toString(16)})}function j(e){X[e]&&Q.debug&&X[e].apply(z,F.call(arguments,1))}function T(){var n=e.RavenConfig
n&&Q.config(n.dsn,n.config).install()}function U(e){var n=[]
return g(e,function(e,t){n.push(encodeURIComponent(e)+"="+encodeURIComponent(t))}),n.join("&")}function N(e,n){u(n)?delete K[e]:K[e]=x(K[e]||{},n)}var A={remoteFetching:!1,collectWindowErrors:!0,linesOfContext:7,debug:!1},F=[].slice,M="?"
...
S>=0&&(w.line=b+g.substring(0,S).split("\n").length)}}else if(c=h.exec(u[a])){var k=e.location.href.replace(/#.*$/,""),R=c[1],C=new RegExp(s(u[a+1]))
g=l(C,[k]),w={url:k,line:g?g.line:R,func:""}}if(w){w.func||(w.func=o(w.url,w.line))
...
var L,I,P,W,D,J=e.Raven,V=!("object"!=typeof JSON||!JSON.stringify),B="undefined"!=typeof document,K={},H={logger:"javascript",ignoreErrors:[],ignoreUrls:[],whitelistUrls:[],includePaths:[],crossOrigin:"anonymous",collectWindowErrors:!0,maxMessageLength:100},Z=!1,q=Object.prototype,z=e.console||{},X={},G=[],Y=b()
for(var $ in z)X[$]=z[$]
var Q={VERSION:"1.3.0",debug:!1,noConflict:function(){return e.Raven=J,Q},config:function(e,n){if(P)return j("error","Error: Raven has already been configured"),Q
if(!e)return Q
var t=i(e),r=t.path.lastIndexOf("/"),o=t.path.substr(1,r)
return n&&g(n,function(e,n){"tags"==e||"extra"==e?K[e]=n:H[e]=n}),H.ignoreErrors.push(/^Script error\.?$/),H.ignoreErrors.push(/^Javascript error: Script error\.? on line 0$/),H.ignoreErrors=_(H.ignoreErrors),H.ignoreUrls=H.ignoreUrls.length?_(H.ignoreUrls):!1,H.whitelistUrls=H.whitelistUrls.length?_(H.whitelistUrls):!1,H.includePaths=_(H.includePaths),W=t.user,D=t.path.substr(r+1),P="//"+t.host+(t.port?":"+t.port:"")+"/"+o+"api/"+D+"/store/",t.protocol&&(P=t.protocol+":"+P),H.fetchContext&&(A.remoteFetching=!0),H.linesOfContext&&(A.linesOfContext=H.linesOfContext),A.collectWindowErrors=!!H.collectWindowErrors,Q},install:function(){return C()&&!Z&&(A.report.subscribe(m),g(G,function(e,n){n()}),Z=!0),Q},context:function(e,t,r){return c(e)&&(r=t||[],t=e,e=n),Q.wrap(e,t).apply(this,r)},wrap:function(e,t){function r(){for(var n=[],r=arguments.length,o=!e||e&&e.deep!==!1;r--;)n[r]=o?Q.wrap(e,arguments[r]):arguments[r]
try{return t.apply(this,n)}catch(i){throw Q.captureException(i,e),i}}if(u(t)&&!c(e))return e
if(c(e)&&(t=e,e=n),!c(t))return t
if(t.__raven__)return t
for(var o in t)p(t,o)&&(r[o]=t[o])
return r.prototype=t.prototype,r.__raven__=!0,r.__inner__=t,r},uninstall:function(){return A.report.uninstall(),Z=!1,Q},captureException:function(e,n){if(!f(e))return Q.captureMessage(e,n)
L=e
try{var t=A.computeStackTrace(e)
m(t,n)}catch(r){if(e!==r)throw r}return Q},captureMessage:function(e,n){return H.ignoreErrors.test&&H.ignoreErrors.test(e)?void 0:(S(x({message:e+""},n)),Q)},addPlugin:function(e){return G.push(e),Z&&e(),Q},setUserContext:function(e){return K.user=e,Q},setExtraContext:function(e){return N("extra",e),Q},setTagsContext:function(e){return N("tags",e),Q},clearContext:function(){return K={},Q},getContext:function(){return JSON.parse(JSON.stringify(K))},setRelease:function(e){return H.release=e,Q},setDataCallback:function(e){return H.dataCallback=e,Q},setShouldSendCallback:function(e){return H.shouldSendCallback=e,Q},setTransport:function(e){return H.transport=e,Q},lastException:function(){return L},lastEventId:function(){return I},isSetup:function(){return C()}}
Q.setUser=Q.setUserContext,Q.setReleaseContext=Q.setRelease
var en="source protocol user pass host port path".split(" "),nn=/^(?:(\w+):)?\/\/(?:(\w+)(:\w+)?@)?([\w\.-]+)(?::(\d+))?(\/.*)/
o.prototype=new Error,o.prototype.constructor=o
var tn
T(),e.Raven=Q,"function"==typeof define&&define.amd?define("raven",[],function(){return Q}):"object"==typeof module?module.exports=Q:"object"==typeof exports&&(exports=Q)}("undefined"!=typeof window?window:this),function(e){"use strict"
...
return n.m=t,n.c=r,n.p="",n(0)}([function(t,n,r){r(1),r(26),r(29),r(40),r(41),r(44),r(46),r(47),r(49),t.exports=r(51)},function(t,n,e){var o=e(2),u=e(3),i=e(4),c=e(5),f=e(7),a=e(11),s=e(13),p=e(14),l=e(12),y=e(15),g=e(16),h=e(21),v=e(22),m=e(23),x=e(24),b=e(17),d=e(10),S=o.getDesc,w=o.setDesc,O=o.create,j=h.get,P=u.Symbol,A=!1,N=y("_hidden"),F=o.isEnum,M=s("symbol-registry"),D=s("symbols"),E="function"==typeof P,_=Object.prototype,T=c?function(){try{return O(w({},N,{get:function(){return w(this,N,{value:!1})[N]}}))[N]||w}catch(t){return function(t,n,r){var e=S(_,n)
e&&delete _[n],w(t,n,r),e&&t!==_&&w(_,n,e)}}}():w,I=function(t){var n=D[t]=O(P.prototype)
return n._k=t,c&&A&&T(_,t,{configurable:!0,set:function(n){i(this,N)&&i(this[N],t)&&(this[N][t]=!1),T(this,t,d(1,n))}}),n},k=function U(t,n,r){return r&&i(D,n)?(r.enumerable?(i(t,N)&&t[N][n]&&(t[N][n]=!1),r=O(r,{enumerable:d(0,!1)})):(i(t,N)||w(t,N,d(1,{})),t[N][n]=!0),T(t,n,r)):w(t,n,r)},J=function q(t,n){x(t)
for(var r,e=v(n=b(n)),o=0,u=e.length;u>o;)k(t,r=e[o++],n[r])
return t},K=function H(t,n){return n===r?O(t):J(O(t),n)},G=function L(t){var n=F.call(this,t)
return n||!i(this,t)||!i(D,t)||i(this,N)&&this[N][t]?n:!0},W=function Q(t,n){var r=S(t=b(t),n)
return!r||!i(D,n)||i(t,N)&&t[N][n]||(r.enumerable=!0),r},B=function R(t){for(var n,r=j(b(t)),e=[],o=0;r.length>o;)i(D,n=r[o++])||n==N||e.push(n)
return e},C=function V(t){for(var n,r=j(b(t)),e=[],o=0;r.length>o;)i(D,n=r[o++])&&e.push(D[n])
return e}
E||(P=function X(){if(this instanceof P)throw TypeError("Symbol is not a constructor")
return I(l(arguments[0]))},a(P.prototype,"toString",function Y(){return this._k}),o.create=K,o.isEnum=G,o.getDesc=W,o.setDesc=k,o.setDescs=J,o.getNames=h.get=B,o.getSymbols=C,c&&!e(25)&&a(_,"propertyIsEnumerable",G,!0)),(!E||e(6)(function(){return"[{},[null]]"!=JSON.stringify([{a:P()},[P()]])}))&&a(P.prototype,"toJSON",function Z(){return E&&m(this)?this:void 0})
var z={"for":function(t){return i(M,t+="")?M[t]:M[t]=P(t)},keyFor:function tn(t){return g(M,t)},useSetter:function(){A=!0},useSimple:function(){A=!1}}
...
z[t]=E?n:I(n)}),A=!0,f(f.G+f.W,{Symbol:P}),f(f.S,"Symbol",z),f(f.S+f.F*!E,"Object",{create:K,defineProperty:k,defineProperties:J,getOwnPropertyDescriptor:W,getOwnPropertyNames:B,getOwnPropertySymbols:C}),p(P,"Symbol"),p(Math,"Math",!0),p(u.JSON,"JSON",!0)},function(t,n){var r=Object
...
g&&(r=n)
for(s in r)p=!(t&a.F)&&v&&s in v,l=(p?v:r)[s],y=t&a.B&&p?f(l,e):h&&"function"==typeof l?f(Function.call,l):l,v&&!p&&i(v,s,l),m[s]!=l&&u(m,s,y),h&&((m[c]||(m[c]={}))[s]=l)}
...
t.exports=r(5)?function(t,n,r){return e.setDesc(t,n,o(1,r))}:function(t,n,r){return t[n]=r,t}},function(t,n){t.exports=function(t,n){return{enumerable:!(1&t),configurable:!(2&t),writable:!(4&t),value:n}}},function(t,n,r){var e=r(3),o=r(9),u=r(12)("src"),i="toString",c=Function[i],f=(""+c).split(i)
r(8).inspectSource=function(t){return c.call(t)},(t.exports=function(t,n,r,i){"function"==typeof r&&(o(r,u,t[n]?""+t[n]:f.join(String(n))),"name"in r||(r.name=n)),t===e?t[n]=r:(i||delete t[n],o(t,n,r))})(Function.prototype,i,function a(){return"function"==typeof this&&this[u]||c.call(this)})},function(t,n){var e=0,o=Math.random()
t.exports=function(t){return"Symbol(".concat(t===r?"":t,")_",(++e+o).toString(36))}},function(t,n,r){var e=r(3),o="__core-js_shared__",u=e[o]||(e[o]={})
t.exports=function(t){return u[t]||(u[t]={})}},function(t,n,r){var e=r(4),o=r(9),u=r(15)("toStringTag")
t.exports=function(t,n,r){t&&!e(t=r?t:t.prototype,u)&&o(t,u,n)}},function(t,n,r){var e=r(13)("wks"),o=r(3).Symbol
t.exports=function(t){return e[t]||(e[t]=o&&o[t]||(o||r(12))("Symbol."+t))}},function(t,n,r){var e=r(2),o=r(17)
t.exports=function(t,n){for(var r,u=o(t),i=e.getKeys(u),c=i.length,f=0;c>f;)if(u[r=i[f++]]===n)return r}},function(t,n,r){var e=r(18),o=r(20)
...
return t}},function(t,n,r){var e={}.toString,o=r(17),u=r(2).getNames,i="object"==typeof window&&Object.getOwnPropertyNames?Object.getOwnPropertyNames(window):[],c=function(t){try{return u(t)}catch(n){return i.slice()}}
t.exports.get=function f(t){return i&&"[object Window]"==e.call(t)?c(t):u(o(t))}},function(t,n,r){var e=r(2)
t.exports=function(t){var n=e.getKeys(t),r=e.getSymbols
if(r)for(var o,u=r(t),i=e.isEnum,c=0;u.length>c;)i.call(t,o=u[c++])&&n.push(o)
...
e(e.S+e.F,"Object",{assign:r(27)})},function(t,n,r){var e=r(28),o=r(18),u=r(22)
t.exports=r(6)(function(){return Symbol()in Object.assign({})})?function i(t,n){for(var r=e(t),i=arguments.length,c=1;i>c;)for(var f,a=o(arguments[c++]),s=u(a),p=s.length,l=0;p>l;)r[f=s[l++]]=a[f]
return r}:Object.assign},function(t,n,r){var e=r(20)
t.exports=function(t){return Object(e(t))}},function(t,n,e){var o=e(30),u=e(7),i=e(28),c=e(32),f=e(33),a=e(35),s=e(37)
u(u.S+u.F*!e(39)(function(t){Array.from(t)}),"Array",{from:function p(t){var n,e,u,p,l=i(t),y="function"==typeof this?this:Array,g=arguments[1],h=g!==r,v=0,m=s(l)
if(h&&(g=o(g,arguments[2],2)),m==r||y==Array&&f(m))for(e=new y(n=a(l.length));n>v;v++)e[v]=h?g(l[v],v):l[v]
else for(p=m.call(l),e=new y;!(u=p.next()).done;v++)e[v]=h?c(p,g,[u.value,v],!0):u.value
return e.length=v,e}})},function(t,n,e){var o=e(31)
...
t.exports=function(t,n,e,u){try{return u?n(o(e)[0],e[1]):n(e)}catch(i){var c=t["return"]
throw c!==r&&o(c.call(t)),i}}},function(t,n,r){var e=r(34),o=r(15)("iterator")
t.exports=function(t){return(e.Array||Array.prototype[o])===t}},function(t,n){t.exports={}},function(t,n,r){var e=r(36),o=Math.min
t.exports=function(t){return t>0?o(e(t),9007199254740991):0}},function(t,n){var r=Math.ceil,e=Math.floor
t.exports=function(t){return isNaN(t=+t)?0:(t>0?e:r)(t)}},function(t,n,e){var o=e(38),u=e(15)("iterator"),i=e(34)
t.exports=e(8).getIteratorMethod=function(t){return t!=r?t[u]||t["@@iterator"]||i[o(t)]:void 0}},function(t,n,e){var o=e(19),u=e(15)("toStringTag"),i="Arguments"==o(function(){return arguments}())
t.exports=function(t){var n,e,c
return t===r?"Undefined":null===t?"Null":"string"==typeof(e=(n=Object(t))[u])?e:i?o(n):"Object"==(c=o(n))&&"function"==typeof n.callee?"Arguments":c}},function(t,n,r){var e=r(15)("iterator"),o=!1
try{var u=[7][e]()
u["return"]=function(){o=!0},Array.from(u,function(){throw 2})}catch(i){}t.exports=function(t){if(!o)return!1
var n=!1
try{var r=[7],u=r[e]()
u.next=function(){n=!0},r[e]=function(){return u},t(r)}catch(i){}return n}},function(t,n,r){var e=r(7)
...
return r.length=n,r}})},function(t,n,e){var o=e(7),u=e(28),i=e(42),c=e(35)
o(o.P,"Array",{fill:function f(t){for(var n=u(this,!0),e=c(n.length),o=i(arguments[1],e),f=arguments[2],a=f===r?e:i(f,e);a>o;)n[o++]=t
return n}}),e(43)("fill")},function(t,n,r){var e=r(36),o=Math.max,u=Math.min
t.exports=function(t,n){return t=e(t),0>t?o(t+n,0):u(t,n)}},function(t,n,r){var e=r(15)("unscopables")
e in[]||r(9)(Array.prototype,e,{}),t.exports=function(t){[][e][t]=!0}},function(t,n,r){var e="find",o=r(7),u=!0,i=r(45)(5)
e in[]&&Array(1)[e](function(){u=!1}),o(o.P+o.F*u,"Array",{find:function c(t){return i(this,t,arguments[1])}}),r(43)(e)},function(t,n,e){var o=e(30),u=e(18),i=e(28),c=e(35)
t.exports=function(t){var n=1==t,e=2==t,f=3==t,a=4==t,s=6==t,p=5==t||s
return function(l,y,g){for(var h,v,m=i(l),x=u(m),b=o(y,g,3),d=c(x.length),S=0,w=n?Array(d):e?[]:r;d>S;S++)if((p||S in x)&&(h=x[S],v=b(h,S,m),t))if(n)w[S]=v
else if(v)switch(t){case 3:return!0
case 5:return h
case 6:return S
case 2:w.push(h)}else if(a)return!1
return s?-1:f||a?a:w}}},function(t,n,r){var e="findIndex",o=r(7),u=!0,i=r(45)(6)
e in[]&&Array(1)[e](function(){u=!1}),o(o.P+o.F*u,"Array",{findIndex:function c(t){return i(this,t,arguments[1])}}),r(43)(e)},function(t,n,r){var e=r(7),o=r(48)(!0)
e(e.P,"Array",{includes:function u(t){return o(this,t,arguments[1])}}),r(43)("includes")},function(t,n,r){var e=r(17),o=r(35),u=r(42)
t.exports=function(t){return function(n,r,i){var c,f=e(n),a=o(f.length),s=u(i,a)
if(t&&r!=r){for(;a>s;)if(c=f[s++],c!=c)return!0}else for(;a>s;s++)if((t||s in f)&&f[s]===r)return t||s
return!t&&-1}}},function(t,n,r){var e=r(7),o=r(50)(!1)
e(e.S,"Object",{values:function u(t){return o(t)}})},function(t,n,r){var e=r(2),o=r(17)
t.exports=function(t){return function(n){var r,u=o(n),i=e.getKeys(u),c=i.length,f=0,a=Array(c)
if(t)for(;c>f;)a[f]=[r=i[f++],u[r]]
else for(;c>f;)a[f]=u[i[f++]]
return a}}},function(t,n,r){var e=r(7),o=r(50)(!0)
