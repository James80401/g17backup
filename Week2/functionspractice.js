...
store4['Dark Chocolate Crunchies']['sold on'].push('2015-01-09')

console.log(store4['Dark Chocolate Crunchies'])

store4['Dark Chocolate Crunchies']['sold on'].push('2015-01-11')

console.log(store4['Dark Chocolate Crunchies'])

store4['Peanut Butter Buttered Peanuts']['sold on'].push('2015-01-09')

console.log(store4['Peanut Butter Buttered Peanuts'])

store4['Peanut Butter Buttered Peanuts']['sold on'].push('2015-01-15')

console.log(store4['Peanut Butter Buttered Peanuts'])

store4['Mint Wafers']['sold on'].push('2015-01-12')

console.log(store4['Mint Wafers'])


store4['Banana Bunches']['sold on'].pop()

store4['Caramel Twists']['sold on'].pop()

console.log(store4);


//being second section of warmup

console.log(store2);
store2['sale dates']['Banana Bunches'].unshift('2015-01-10');

store2['sale dates']['Banana Bunches'].unshift('2015-01-10');

store2['sale dates']['Caramel Twists'].unshift('2015-01-10');

console.log(store2);

store2['sale dates']['Peanut Butter Buttered Peanuts'].shift();

store2['sale dates']['Mint Wafers'].shift();

store2['sale dates']['Berry Bites'].shift();

console.log(store2['sale dates']);
