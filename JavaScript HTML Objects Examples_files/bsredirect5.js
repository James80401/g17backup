...
window.document.updateSettings&&"function"==typeof window.document.updateSettings)return 1;var b=!1;try{var d=document.createElement("p");d.innerText=".";d.style="text-shadow: rgb(99, 116, 171) 20px -12px 2px";b=void 0!=d.style.textShadow}catch(e){}return 0<Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor")&&b&&void 0!=window.innerWidth&&void 0!=window.innerHeight?5:0}catch(k){return 0}}this.createRequest=function(){var c=!1,b=window,d=0,e=!1;try{for(dv_i=0;10>=dv_i;dv_i++)if(null!=
b.parent&&b.parent!=b)if(0<b.parent.location.toString().length)b=b.parent,d++,c=!0;else{c=!1;break}else{0==dv_i&&(c=!0);break}}catch(k){c=!1}0==b.document.referrer.length?c=b.location:c?c=b.location:(c=b.document.referrer,e=!0);var a=document.getElementsByTagName("script");for(dv_i in a)if(a[dv_i].src){var t=a[dv_i].src;if(t=t&&t.match(/bsredirect5(_plain)?\.js\?callback=/)?t.replace(/^.+?callback=(.+?)(&|$)/,"$1"):null)if((this.redirect=eval(t+"()"))&&!this.redirect.done)return this.redirect.done=
!0,b=B(this.redirect,c,b,d,e,a[dv_i]&&a[dv_i].parentElement&&a[dv_i].parentElement.tagName&&"HEAD"===a[dv_i].parentElement.tagName,a[dv_i]),b+="&"+this.getVersionParamName()+"="+this.getVersion()}};this.isApplicable=function(){return!0};this.onFailure=function(){};this.sendRequest=function(c){dv_sendRequest(c);return!0};if(window.debugScript&&(!window.minDebugVersion||10>=window.minDebugVersion))window.DvVerify=B,window.createRequest=this.createRequest;this.getVersionParamName=function(){return"ver"};
this.getVersion=function(){return"22"}};
